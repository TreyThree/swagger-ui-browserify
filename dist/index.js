...
SwaggerUi.Views.SidebarHeaderView = Backbone.View.extend({options: {swaggerOptions: {}},
  initialize: function (opts) {
    this.options = opts || {};
    this.router = this.options.router;
  },
...
SwaggerUi.Views.SidebarItemView = Backbone.View.extend({options: {swaggerOptions: {}},
